...
export class HsptModel {
  ...
  nodelOfficerNum: string = '';
  nodelOfficerEmailId: string = '';
  ...
  hsptMiscellaneousList: Array<HsptMiscellaneousModel> =
    new Array<HsptMiscellaneousModel>();
  ...
  hsptAddresses: Array<HsptAddressModel> = new Array<HsptAddressModel>();
}
